...
public class UserRepositoryImpl implements UserRepository {
    ...
    private static final String SQL_BY_USERNAME_AND_PASSWORD = "SELECT u.login, u.password FROM users u WHERE u.login = ? AND u.password = ?";
